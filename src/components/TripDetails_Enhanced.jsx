                ...
                >
                  ...
                  <div className="card-premium p-6 sm:p-8">
                    <div className="flex items-center space-x-3 mb-6">
                      ...
                      <h2 className="text-2xl sm:text-3xl font-black text-slate-800">Safety First</h2>
                    </div>
                    <div className="alert-info">
                      <div className="flex items-start">
                        <AlertCircle className="w-6 h-6 text-blue-600 mr-3 flex-shrink-0 mt-1" />
                        <div>
                          <h4 className="font-bold text-blue-900 mb-2">Important Safety Guidelines</h4>
                          <ul className="space-y-2 text-blue-800">
                            <li>• Follow guide instructions at all times</li>
                            <li>• Stay with the group during activities</li>
